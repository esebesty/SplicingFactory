...
#' @return Raw and Benjamini-Hochberg corrected p-values in a matrix.
#' @import stats
wilcoxon <- function(x, samples, paired = FALSE, exact = FALSE) {
...
#' @return Raw and Benjamini-Hochberg corrected p-values.
#' @import stats
